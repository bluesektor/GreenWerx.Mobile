...
export class HomePage implements OnInit {
  ...
  @ViewChild('ctlList', {static: false}) listControl: any;
          ...
          handler: () => {
            ...
            */
            ...
            this.eventService.deleteEvent(item.UUID).subscribe((response) => {
              ...
              this.messages.publish('api:ok',200, 'Event Removed');
            }, (err) => {
    ...
    switch ( this.viewType) {
      case 'event':
          ...
          await svc.subscribe((response) => {
            ...
            this.messages.publish('api:ok',200, 'Favorite Added');
          }, (err) => {
            this.messages.publish('service:err', err);
        });
      break;
        ...
        },
        {
          ...
          handler: () => {
                ...
                this.eventService.removeFavorite(item.UUID).subscribe((response) => {
                  ...
                  this.updateList();
                  this.messages.publish('api:ok',200, 'Favorite Removed');
                }, (err) => {
                  this.messages.publish('service:err', err, '');
              });
          }
